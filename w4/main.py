...
for day in weekList:
    ...
    if dayOfWeek == 0:
        ...
        if(workToday == 1):
            ...
            print(f"We will work on {musclesToWork[randWorkOut]} and tricepts")
    ...
    print("Would you Like to see the schedule for tomorow?")
    choice = input("Enter 'y' for yes: ")
    choice = choice.lower()
    if choice == 'y' and dayOfWeek == 6:
        dayOfWeek = 0
    elif choice == 'y':
        dayOfWeek += 1
    else:
